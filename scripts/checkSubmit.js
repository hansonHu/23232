...
function hardware_add(){
	...
	$.ajax({
	   ...
	   data: "&mcode="+$("input[name='mcode']").val()+"&username="+$("input[name='username']").val()+"&mkey="+$("input[name='mkey']").val()+"&count="+$("input[name='count']").val()+"&mp="+$("input[name='mp']").val()+"&store_id="+$("select[name='store_id']").val()+"&paid="+$("input[name='paid']").val()+"&maycms_id="+$("input[name='maycms_id']").val(),
